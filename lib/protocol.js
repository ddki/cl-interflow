...
var caller = function caller() {
    var packIn = arguments.length <= 0 || arguments[0] === undefined ? defPackIn : arguments[0];
    ...
    return function (connect) {
        ...
        return function () {
            ...
            return new Promise(function (resolve, reject) {
                var rawIn = packIn.apply(undefined, ins);
...
var defPackIn = function defPackIn() {
    for (var _len2 = arguments.length, ins = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        ins[_key2] = arguments[_key2];
    }
